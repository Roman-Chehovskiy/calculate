...
public class RomanNumbers {
    ...
    public static String convertToRoman(int c) throws InterException {
        if (c > 0) {
            String str = "";
            ...
            throw new InterException("не верный результат операции, римское число должно быть больше 0");
        }
        }
